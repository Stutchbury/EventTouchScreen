...
#ifndef EVENT_TOUCH_SCREEN_H
#define EVENT_TOUCH_SCREEN_H
...
/**
 * @brief The EventTouchScreen class
 * 
 */
class EventTouchScreen : public EventInputBase {
     ...
     * 
     * @param touchAdapter A previously created TouchScreenAdapter passed by reference.
     */
    EventTouchScreen(TouchScreenAdapter *touchAdapter);
    ...
    /**
     * @brief Get the TouchPoint struct containing the touched X and Y display coordinates.
    ...
    /**
     * @brief Get the Previous TouchPoint struct
     * 
     * @return TouchScreenAdapter::TouchPoint 
     */
    TouchScreenAdapter::TouchPoint getPreviousTouchPoint() { return previousTouchPoint; }

    /**
     * @brief Get the starting TouchPoint struct
     * 
     * @details Used for DRAGGED or DRAGGED_RELEASED events. 
     * 
     * @return TouchScreenAdapter::TouchPoint 
     */
    TouchScreenAdapter::TouchPoint getStartTouchPoint() { return startTouchPoint; }
...
private:
    ...
    TouchScreenAdapter *touchAdapter = nullptr;
